...
import com.core.network.callback.BitmapCallback;
import com.core.network.callback.FileCallback;
import com.core.network.callback.GenericsCallback;
import com.google.gson.Gson;


import com.core.network.callback.StringCallback;
...
public class TestActivity extends Activity {
    ...
    public class MyStringCallback extends StringCallback
    {
        ...
        public void onResponse(String response, int id)
        {
            ...
            {
                case 100:
                    Toast.makeText(TestActivity.this, "http", Toast.LENGTH_SHORT).show();
                    break;
                case 101:
                    Toast.makeText(TestActivity.this, "https", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    ...
    public void postFile(View view)
    {
        ...
        if (!file.exists())
        {
            Toast.makeText(TestActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        }
